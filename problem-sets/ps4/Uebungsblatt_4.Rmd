...
cor(eu_makro$unempl, y = eu_makro$debt_share_country_pro, use = "pairwise.complete.obs")
...
dat$country %in% c("Germany","France","Netherlands")
...
pwt <- pwt %>% mutate(log_bip = log(bip),
               log_k = log(k))
